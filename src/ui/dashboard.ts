...
<body>
  ...
  (() => {
    ...
    const renderProgramming = () => { const section = heading("Programming Control Plane", "The local control-plane contract remains separate from M4 schedule publication and M5 runtime execution. This M3.8 dashboard shell is read-only."); section.append(el("span", { class: "unavailable-affordance", "aria-disabled": "true" }, "Programming authoring and publication are not dashboard actions in this shell")); return [section]; };
